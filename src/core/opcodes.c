...
u8 gb_emu_execute_opcode(gb_emu_t* emu)
{
	...
	switch (opcode) {
		...
		/* LD C, D */ case 0x4A: {
			GB_REG_C(emu->cpu.regs) = GB_REG_D(emu->cpu.regs);
			return 1;
		}

		/* LD C, E */ case 0x4B: {
			GB_REG_C(emu->cpu.regs) = GB_REG_E(emu->cpu.regs);
			return 1;
		}

		/* LD C, H */ case 0x4C: {
			GB_REG_C(emu->cpu.regs) = GB_REG_H(emu->cpu.regs);
			return 1;
		}

		/* LD C, L */ case 0x4D: {
			GB_REG_C(emu->cpu.regs) = GB_REG_L(emu->cpu.regs);
			return 1;
		}
		...
		/* LD C, A */ case 0x4F: {
			GB_REG_C(emu->cpu.regs) = GB_REG_A(emu->cpu.regs);
			return 1;
		}
		...
		/* LD D, C */ case 0x51: {
			GB_REG_D(emu->cpu.regs) = GB_REG_C(emu->cpu.regs);
			return 1;
		}

		/* LD D, E */ case 0x53: {
			GB_REG_D(emu->cpu.regs) = GB_REG_E(emu->cpu.regs);
			return 1;
		}

		/* LD D, H */ case 0x54: {
			GB_REG_D(emu->cpu.regs) = GB_REG_H(emu->cpu.regs);
			return 1;
		}
		...
		/* LD E, B */ case 0x58: {
			GB_REG_E(emu->cpu.regs) = GB_REG_B(emu->cpu.regs);
			return 1;
		}

		/* LD E, C */ case 0x59: {
			GB_REG_E(emu->cpu.regs) = GB_REG_C(emu->cpu.regs);
			return 1;
		}

		/* LD E, D */ case 0x5A: {
			GB_REG_E(emu->cpu.regs) = GB_REG_D(emu->cpu.regs);
			return 1;
		}

		/* LD E, H */ case 0x5C: {
			GB_REG_E(emu->cpu.regs) = GB_REG_H(emu->cpu.regs);
			return 1;
		}

		/* LD E, L */ case 0x5D: {
			GB_REG_E(emu->cpu.regs) = GB_REG_L(emu->cpu.regs);
			return 1;
		}
		...
		/* LD H, C */ case 0x61: {
			GB_REG_H(emu->cpu.regs) = GB_REG_C(emu->cpu.regs);
			return 1;
		}

		/* LD H, D */ case 0x62: {
			GB_REG_H(emu->cpu.regs) = GB_REG_D(emu->cpu.regs);
			return 1;
		}

		/* LD H, E */ case 0x63: {
			GB_REG_H(emu->cpu.regs) = GB_REG_E(emu->cpu.regs);
			return 1;
		}
		...
		/* LD L, B */ case 0x68: {
			GB_REG_L(emu->cpu.regs) = GB_REG_B(emu->cpu.regs);
			return 1;
		}

		/* LD L, C */ case 0x69: {
			GB_REG_L(emu->cpu.regs) = GB_REG_C(emu->cpu.regs);
			return 1;
		}
		...
		/* LD L, H */ case 0x6C: {
			GB_REG_L(emu->cpu.regs) = GB_REG_H(emu->cpu.regs);
			return 1;
		}
		...
		/* LD L, A */ case 0x6F: {
			GB_REG_L(emu->cpu.regs) = GB_REG_A(emu->cpu.regs);
			return 1;
		}
		...
		/* LD (HL), B */ case 0x70: {
			uint16_t addr = GB_REG_HL(emu->cpu.regs);
			gb_emu_write_u8(emu, addr, GB_REG_B(emu->cpu.regs));
			return 2;
		}

		/* LD (HL), C */ case 0x71: {
			uint16_t addr = GB_REG_HL(emu->cpu.regs);
			gb_emu_write_u8(emu, addr, GB_REG_C(emu->cpu.regs));
			return 2;
		}

		/* LD (HL), D */ case 0x72: {
			uint16_t addr = GB_REG_HL(emu->cpu.regs);
			gb_emu_write_u8(emu, addr, GB_REG_D(emu->cpu.regs));
			return 2;
		}

		/* LD (HL), E */ case 0x73: {
			uint16_t addr = GB_REG_HL(emu->cpu.regs);
			gb_emu_write_u8(emu, addr, GB_REG_E(emu->cpu.regs));
			return 2;
		}

		/* LD (HL), H */ case 0x74: {
			uint16_t addr = GB_REG_HL(emu->cpu.regs);
			gb_emu_write_u8(emu, addr, GB_REG_H(emu->cpu.regs));
			return 2;
		}

		/* LD (HL), L */ case 0x75: {
			uint16_t addr = GB_REG_HL(emu->cpu.regs);
			gb_emu_write_u8(emu, addr, GB_REG_L(emu->cpu.regs));
			return 2;
		}
		...
		/* LD A, B */ case 0x78: {
			GB_REG_A(emu->cpu.regs) = GB_REG_B(emu->cpu.regs);
			return 1;
		}

		/* LD A, C */ case 0x79: {
			GB_REG_A(emu->cpu.regs) = GB_REG_C(emu->cpu.regs);
			return 1;
		}
		...
		/* LD A, (BC) */ case 0x0A: {
			u8 data = gb_emu_read_u8(emu, GB_REG_BC(emu->cpu.regs));
			GB_REG_A(emu->cpu.regs) = data;
			return 2;
		}

		/* LD A, (DE) */ case 0x1A: {
			u8 data = gb_emu_read_u8(emu, GB_REG_DE(emu->cpu.regs));
			GB_REG_A(emu->cpu.regs) = data;
			return 2;
		}
		...
		/* ADD B */ case 0x80: {
			_gb_add(&emu->cpu, GB_REG_B(emu->cpu.regs));
			return 1;
		}
		/* ADD C */ case 0x81: {
			_gb_add(&emu->cpu, GB_REG_C(emu->cpu.regs));
			return 1;
		}
		/* ADD D */ case 0x82: {
			_gb_add(&emu->cpu, GB_REG_D(emu->cpu.regs));
			return 1;
		}
		/* ADD E */ case 0x83: {
			_gb_add(&emu->cpu, GB_REG_E(emu->cpu.regs));
			return 1;
		}
		/* ADD H */ case 0x84: {
			_gb_add(&emu->cpu, GB_REG_H(emu->cpu.regs));
			return 1;
		}
		/* ADD L */ case 0x85: {
			_gb_add(&emu->cpu, GB_REG_L(emu->cpu.regs));
			return 1;
		}
		/* ADD [HL] */ case 0x86: {
			const u8 d = gb_emu_read_u8(emu, GB_REG_HL(emu->cpu.regs));
		...
		/* ADD A */ case 0x87: {
			_gb_add(&emu->cpu, GB_REG_A(emu->cpu.regs));
			return 1;
		}
		/* ADD d8 */ case 0xC6: {
			const u8 d = gb_emu_read_u8(emu, GB_REG_PC(emu->cpu.regs));
		...
		/* POP BC */ case 0xC1: {
			GB_REG_BC(emu->cpu.regs) = gb_emu_pop_u16(emu);
			return 3;
		}
		/* POP DE */ case 0xD1: {
			GB_REG_DE(emu->cpu.regs) = gb_emu_pop_u16(emu);
			return 3;
		}
		/* POP HL */ case 0xE1: {
			GB_REG_HL(emu->cpu.regs) = gb_emu_pop_u16(emu);
			return 3;
		}
		/* POP AF */ case 0xF1: {
			GB_REG_AF(emu->cpu.regs) = gb_emu_pop_u16(emu);
			return 3;
		}

		/* PUSH BC */ case 0xC5: {
			gb_emu_push_u16(emu, GB_REG_BC(emu->cpu.regs));
			return 4;
		}
		/* PUSH DE */ case 0xD5: {
			gb_emu_push_u16(emu, GB_REG_DE(emu->cpu.regs));
			return 4;
		}
		/* PUSH HL */ case 0xE5: {
			gb_emu_push_u16(emu, GB_REG_HL(emu->cpu.regs));
			return 4;
		}
		/* PUSH AF */ case 0xF5: {
			gb_emu_push_u16(emu, GB_REG_AF(emu->cpu.regs));
			return 4;
		}
...
static u8 gb_emu_execute_cb(gb_emu_t* emu)
{
	...
	switch (opcode) {
		...
		/* BIT 0, B */ case 0x40: {
			_gb_get_bit(&emu->cpu, GB_REG_B(emu->cpu.regs), 0);
			return 2;
		}
		/* BIT 0, C */ case 0x41: {
			_gb_get_bit(&emu->cpu, GB_REG_C(emu->cpu.regs), 0);
			return 2;
		}
		/* BIT 0, D */ case 0x42: {
			_gb_get_bit(&emu->cpu, GB_REG_D(emu->cpu.regs), 0);
			return 2;
		}
		/* BIT 0, E */ case 0x43: {
			_gb_get_bit(&emu->cpu, GB_REG_E(emu->cpu.regs), 0);
			return 2;
		}
		/* BIT 0, H */ case 0x44: {
			_gb_get_bit(&emu->cpu, GB_REG_H(emu->cpu.regs), 0);
			return 2;
		}
		/* BIT 0, L */ case 0x45: {
			_gb_get_bit(&emu->cpu, GB_REG_L(emu->cpu.regs), 0);
			return 2;
		}
		/* BIT 0, (HL) */ case 0x46: {
			u8 data = gb_emu_read_u8(emu, GB_REG_HL(emu->cpu.regs));
			_gb_get_bit(&emu->cpu, data, 0);
			return 4;
		}
		/* BIT 0, A */ case 0x47: {
			_gb_get_bit(&emu->cpu, GB_REG_A(emu->cpu.regs), 0);
			return 2;
		}

		/* BIT 1, B */ case 0x48: {
			_gb_get_bit(&emu->cpu, GB_REG_B(emu->cpu.regs), 1);
			return 2;
		}
		/* BIT 1, C */ case 0x49: {
			_gb_get_bit(&emu->cpu, GB_REG_C(emu->cpu.regs), 1);
			return 2;
		}
		/* BIT 1, D */ case 0x4A: {
			_gb_get_bit(&emu->cpu, GB_REG_D(emu->cpu.regs), 1);
			return 2;
		}
		/* BIT 1, E */ case 0x4B: {
			_gb_get_bit(&emu->cpu, GB_REG_E(emu->cpu.regs), 1);
			return 2;
		}
		/* BIT 1, H */ case 0x4C: {
			_gb_get_bit(&emu->cpu, GB_REG_H(emu->cpu.regs), 1);
			return 2;
		}
		/* BIT 1, L */ case 0x4D: {
			_gb_get_bit(&emu->cpu, GB_REG_L(emu->cpu.regs), 1);
			return 2;
		}
		/* BIT 1, (HL) */ case 0x4E: {
			u8 data = gb_emu_read_u8(emu, GB_REG_HL(emu->cpu.regs));
			_gb_get_bit(&emu->cpu, data, 1);
			return 4;
		}
		/* BIT 1, A */ case 0x4F: {
			_gb_get_bit(&emu->cpu, GB_REG_A(emu->cpu.regs), 1);
			return 2;
		}

		/* BIT 2, B */ case 0x50: {
			_gb_get_bit(&emu->cpu, GB_REG_B(emu->cpu.regs), 2);
			return 2;
		}
		/* BIT 2, C */ case 0x51: {
			_gb_get_bit(&emu->cpu, GB_REG_C(emu->cpu.regs), 2);
			return 2;
		}
		/* BIT 2, D */ case 0x52: {
			_gb_get_bit(&emu->cpu, GB_REG_D(emu->cpu.regs), 2);
			return 2;
		}
		/* BIT 2, E */ case 0x53: {
			_gb_get_bit(&emu->cpu, GB_REG_E(emu->cpu.regs), 2);
			return 2;
		}
		/* BIT 2, H */ case 0x54: {
			_gb_get_bit(&emu->cpu, GB_REG_H(emu->cpu.regs), 2);
			return 2;
		}
		/* BIT 2, L */ case 0x55: {
			_gb_get_bit(&emu->cpu, GB_REG_L(emu->cpu.regs), 2);
			return 2;
		}
		/* BIT 2, (HL) */ case 0x56: {
			u8 data = gb_emu_read_u8(emu, GB_REG_HL(emu->cpu.regs));
			_gb_get_bit(&emu->cpu, data, 2);
			return 4;
		}
		/* BIT 2, A */ case 0x57: {
			_gb_get_bit(&emu->cpu, GB_REG_A(emu->cpu.regs), 2);
			return 2;
		}

		/* BIT 3, B */ case 0x58: {
			_gb_get_bit(&emu->cpu, GB_REG_B(emu->cpu.regs), 3);
			return 2;
		}
		/* BIT 3, C */ case 0x59: {
			_gb_get_bit(&emu->cpu, GB_REG_C(emu->cpu.regs), 3);
			return 2;
		}
		/* BIT 3, D */ case 0x5A: {
			_gb_get_bit(&emu->cpu, GB_REG_D(emu->cpu.regs), 3);
			return 2;
		}
		/* BIT 3, E */ case 0x5B: {
			_gb_get_bit(&emu->cpu, GB_REG_E(emu->cpu.regs), 3);
			return 2;
		}
		/* BIT 3, H */ case 0x5C: {
			_gb_get_bit(&emu->cpu, GB_REG_H(emu->cpu.regs), 3);
			return 2;
		}
		/* BIT 3, L */ case 0x5D: {
			_gb_get_bit(&emu->cpu, GB_REG_L(emu->cpu.regs), 3);
			return 2;
		}
		/* BIT 3, (HL) */ case 0x5E: {
			u8 data = gb_emu_read_u8(emu, GB_REG_HL(emu->cpu.regs));
			_gb_get_bit(&emu->cpu, data, 3);
			return 4;
		}
		/* BIT 3, A */ case 0x5F: {
			_gb_get_bit(&emu->cpu, GB_REG_A(emu->cpu.regs), 3);
			return 2;
		}

		/* BIT 4, B */ case 0x60: {
			_gb_get_bit(&emu->cpu, GB_REG_B(emu->cpu.regs), 4);
			return 2;
		}
		/* BIT 4, C */ case 0x61: {
			_gb_get_bit(&emu->cpu, GB_REG_C(emu->cpu.regs), 4);
			return 2;
		}
		/* BIT 4, D */ case 0x62: {
			_gb_get_bit(&emu->cpu, GB_REG_D(emu->cpu.regs), 4);
			return 2;
		}
		/* BIT 4, E */ case 0x63: {
			_gb_get_bit(&emu->cpu, GB_REG_E(emu->cpu.regs), 4);
			return 2;
		}
		/* BIT 4, H */ case 0x64: {
			_gb_get_bit(&emu->cpu, GB_REG_H(emu->cpu.regs), 4);
			return 2;
		}
		/* BIT 4, L */ case 0x65: {
			_gb_get_bit(&emu->cpu, GB_REG_L(emu->cpu.regs), 4);
			return 2;
		}
		/* BIT 4, (HL) */ case 0x66: {
			u8 data = gb_emu_read_u8(emu, GB_REG_HL(emu->cpu.regs));
			_gb_get_bit(&emu->cpu, data, 4);
			return 4;
		}
		/* BIT 4, A */ case 0x67: {
			_gb_get_bit(&emu->cpu, GB_REG_A(emu->cpu.regs), 4);
			return 2;
		}

		/* BIT 5, B */ case 0x68: {
			_gb_get_bit(&emu->cpu, GB_REG_B(emu->cpu.regs), 5);
			return 2;
		}
		/* BIT 5, C */ case 0x69: {
			_gb_get_bit(&emu->cpu, GB_REG_C(emu->cpu.regs), 5);
			return 2;
		}
		/* BIT 5, D */ case 0x6A: {
			_gb_get_bit(&emu->cpu, GB_REG_D(emu->cpu.regs), 5);
			return 2;
		}
		/* BIT 5, E */ case 0x6B: {
			_gb_get_bit(&emu->cpu, GB_REG_E(emu->cpu.regs), 5);
			return 2;
		}
		/* BIT 5, H */ case 0x6C: {
			_gb_get_bit(&emu->cpu, GB_REG_H(emu->cpu.regs), 5);
			return 2;
		}
		/* BIT 5, L */ case 0x6D: {
			_gb_get_bit(&emu->cpu, GB_REG_L(emu->cpu.regs), 5);
			return 2;
		}
		/* BIT 5, (HL) */ case 0x6E: {
			u8 data = gb_emu_read_u8(emu, GB_REG_HL(emu->cpu.regs));
			_gb_get_bit(&emu->cpu, data, 5);
			return 4;
		}
		/* BIT 5, A */ case 0x6F: {
			_gb_get_bit(&emu->cpu, GB_REG_A(emu->cpu.regs), 5);
			return 2;
		}

		/* BIT 6, B */ case 0x70: {
			_gb_get_bit(&emu->cpu, GB_REG_B(emu->cpu.regs), 6);
			return 2;
		}
		/* BIT 6, C */ case 0x71: {
			_gb_get_bit(&emu->cpu, GB_REG_C(emu->cpu.regs), 6);
			return 2;
		}
		/* BIT 6, D */ case 0x72: {
			_gb_get_bit(&emu->cpu, GB_REG_D(emu->cpu.regs), 6);
			return 2;
		}
		/* BIT 6, E */ case 0x73: {
			_gb_get_bit(&emu->cpu, GB_REG_E(emu->cpu.regs), 6);
			return 2;
		}
		/* BIT 6, H */ case 0x74: {
			_gb_get_bit(&emu->cpu, GB_REG_H(emu->cpu.regs), 6);
			return 2;
		}
		/* BIT 6, L */ case 0x75: {
			_gb_get_bit(&emu->cpu, GB_REG_L(emu->cpu.regs), 6);
			return 2;
		}
		/* BIT 6, (HL) */ case 0x76: {
			u8 data = gb_emu_read_u8(emu, GB_REG_HL(emu->cpu.regs));
			_gb_get_bit(&emu->cpu, data, 6);
			return 4;
		}
		/* BIT 6, A */ case 0x77: {
			_gb_get_bit(&emu->cpu, GB_REG_A(emu->cpu.regs), 6);
			return 2;
		}

		/* BIT 7, B */ case 0x78: {
			_gb_get_bit(&emu->cpu, GB_REG_B(emu->cpu.regs), 7);
			return 2;
		}
		/* BIT 7, C */ case 0x79: {
			_gb_get_bit(&emu->cpu, GB_REG_C(emu->cpu.regs), 7);
			return 2;
		}
		/* BIT 7, D */ case 0x7A: {
			_gb_get_bit(&emu->cpu, GB_REG_D(emu->cpu.regs), 7);
			return 2;
		}
		/* BIT 7, E */ case 0x7B: {
			_gb_get_bit(&emu->cpu, GB_REG_E(emu->cpu.regs), 7);
			return 2;
		}
		/* BIT 7, H */ case 0x7C: {
			_gb_get_bit(&emu->cpu, GB_REG_H(emu->cpu.regs), 7);
			return 2;
		}
		/* BIT 7, L */ case 0x7D: {
			_gb_get_bit(&emu->cpu, GB_REG_L(emu->cpu.regs), 7);
			return 2;
		}
		/* BIT 7, (HL) */ case 0x7E: {
			u8 data = gb_emu_read_u8(emu, GB_REG_HL(emu->cpu.regs));
			_gb_get_bit(&emu->cpu, data, 7);
			return 4;
		}
		/* BIT 7, A */ case 0x7F: {
			_gb_get_bit(&emu->cpu, GB_REG_A(emu->cpu.regs), 7);
			return 2;
		}
